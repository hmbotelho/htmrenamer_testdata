...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="Data">
		...
		<xsl:apply-templates select="Image/Attachment[@Name='DetectorOverloadInfo']/Detector"/>
		<xsl:apply-templates select="Image/Attachment/LDM_Block_Sequential/LDM_Block_Sequential_List"/>
		<xsl:apply-templates select="Image/Attachment/LDM_Block_Sequential/LDM_Block_Sequential_Master/ATLConfocalSettingDefinition/AdditionalInfoForDeconvolution"/>
	</xsl:template>
                ...
                Absolute Time (h:m:s.ms)
						...
						<xsl:for-each select="TimeStamp">
							<TR style="font-family: arial, helvetica; font-size: 7pt; font-weight: normal; color: 000000; padding: 3px;">
								<TD>
									<xsl:value-of select="@StartTime"/>.<xsl:value-of select="@StartMiliSeconds"/>
								</TD>
								<TD>
									<xsl:value-of select="@DeltaTime"/>
								</TD>
								<TD>
                      ...
                      Total Exposures: <B>
                        ...
                        <xsl:choose>
                              ...
                              based on image data from <xsl:value-of select="/Data/Image/Attachment[@Name='HardwareSetting']/@Software"/>
													...
													<xsl:otherwise>
														<b>
															<xsl:value-of select="/Data/Image/Attachment[@Name='HardwareSetting']/@Software"/>
														</b>
													</xsl:otherwise>
												</xsl:choose>
											</TD>
							...
							<TD align="center" valign="center" rowspan="2">
								...
								<br/>
								<DIV id="ID_Active_Text" name="ID_Active_Text" style="display:none;">
									Shown Devices: only <span id="ID_Active" name="ID_Active" style="display:inline;color:green">Active</span>
									<span id="ID_Inactive" name="ID_Inactive" style="display:inline;color:darkgray">Inactive</span>
									(<a href="javascript:ShowInactiveDetails()">Toggle</a>)																	
								</DIV>
								<DIV id="ID_Inactive_Text" name="ID_Inactive_Text" style="display:block">
				...
				<TD>
                  ...
                  <xsl:choose>
								...
								<TD>
									...
									<xsl:choose>
										<xsl:when test="@UnitEndPosition != ''">
											<xsl:value-of select="@UnitEndPosition"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="@Unit"/>
										</xsl:otherwise>
						...
						<xsl:for-each select="Block_FRAP">
							<xsl:for-each select="Block_FRAP_Bleach_Info/LaserLineSettingArray">
								<xsl:for-each select="LaserLineSetting">
									<xsl:choose>
										<xsl:when test="contains(@IntensityShow,'Shutter: off') or @IntensityShow='Shutter: on, Intensity: 0.0000%'" >
											<TR id="ID_Inactive_TR" name="ID_Inactive_TR" style="font-family: arial, helvetica; font-size: 7pt; font-weight: normal; color: 000000; padding: 3px;">
												<TD width="40%">
										...
										<xsl:otherwise>
											<TR id="ID_Active_TR" name="ID_Active_TR" style="font-family: arial, helvetica; font-size: 7pt; font-weight: normal; color: 000000; padding: 3px;">
												<TD width="40%">
													Laser Line <xsl:value-of select="@AotfType"/> (<xsl:value-of select="@LaserLine"/>nm)
												</TD>
												<TD>
                    ...
                    PinholeAiry
                      ...
                      EmissionWavelength for PinholeAiry Calculation
							...
							<xsl:for-each select="DetectorList/Detector">
								<xsl:choose>
									<xsl:when test="@IsActive='0'">
										<TR name="ID_Inactive_TR" id="ID_Inactive_TR" style="font-family: arial, helvetica; font-size: 7pt; font-weight: normal; color: 000000; padding: 3px;">
											<TD width="40%">
                        ...
                        <xsl:choose>
                          ...
                          <xsl:when test="@AcquisitionModeName = 'PhotonIntegrationPulse'">
                            Pulse mode [Calibr. value: <xsl:value-of select="@PulseModeCalibrationValue"/>]
                          </xsl:when>
                          <xsl:when test="@AcquisitionModeName = 'PhotonCounting'">
                            Counting mode
                          </xsl:when>
                          <xsl:when test="@AcquisitionModeName = 'BrightR'">
                            BrightR mode
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:value-of select="@AcquisitionModeName"/>
									...
									<xsl:otherwise>
										<TR name="ID_Active_TR" id="ID_Active_TR" style="font-family: arial, helvetica; font-size: 7pt; font-weight: normal; color: 000000; padding: 3px;">
											<TD width="40%">
												<xsl:value-of select="@Name"/> &nbsp; <xsl:value-of select="@Band"/> &nbsp;
                        <xsl:choose>
                          <xsl:when test="@AcquisitionModeName = 'PhotonIntegration'">
	...
	<xsl:template match="AdditionalInfoForDeconvolution">
		<TABLE width="98%" align="center" border="0" cellspacing="5" cellpadding="5">
			<TR>
				<TD align="left" style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 3px;">
		...
		<TABLE width="98%" align="center" border="0" cellspacing="0" cellpadding="5" bgcolor="#DDDAD7">
			<TR>
                ...
                Mounting Medium
							...
							<TD>
								<xsl:choose>
									<xsl:when test="@MountingMedium!=''">
										<xsl:value-of select="@MountingMedium"/>
									</xsl:when>
									<xsl:otherwise> -- </xsl:otherwise>
								</xsl:choose>
							</TD>
                ...
                Mounting Medium Refractive Index
							...
							<TD>
								<xsl:choose>
									<xsl:when test="@MountingMediumRefractiveIndex!=''">
										<xsl:value-of select="@MountingMediumRefractiveIndex"/>
									</xsl:when>
									<xsl:otherwise> -- </xsl:otherwise>
								</xsl:choose>								
							</TD>
	...
	<xsl:template match="Attachment">
			...
			<TABLE width="98%" align="center" border="0" cellspacing="0" cellpadding="5" bgcolor="#DDDAD7">
				<TR>
                  ...
                  Value
							...
							<xsl:for-each select="ATLConfocalSettingDefinition">
							<xsl:choose>
									<xsl:when test="@RotatorAngle">
										<TR style="font-family: arial, helvetica; font-size: 7pt; font-weight: normal; color: 000000; padding: 3px;">
											<TD width="40%">
												Rotator Angle
											</TD>
											<TD>
												<xsl:value-of select="@RotatorAngle"/>
											</TD>
										</TR>
									</xsl:when>
								</xsl:choose>
            ...
            <TABLE topmargin="0" leftmargin="0" width="100%" align="left" border="1" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
                  ...
                  OutputPower
							...
							<xsl:for-each select="ATLConfocalSettingDefinition/LaserArray/Laser">
								<xsl:choose>
									<xsl:when test="@PowerState='On' ">
										<TR id="ID_Active_TR" name="ID_Active_TR" style="font-family: arial, helvetica; font-size: 7pt; font-weight: bold; color: 000000; padding: 3px;">
											<TD>
									...
									<xsl:otherwise>
										<TR name="ID_Inactive_TR" id="ID_Inactive_TR" style="font-family: arial, helvetica; font-size: 7pt; font-weight: bold; color: 000000; padding: 3px;">
											<TD>
												<xsl:value-of select="@LaserName"/>
											</TD>
											<TD>
			...
			<TABLE width="98%" align="center" border="0" cellspacing="0" cellpadding="5">
				...
				<xsl:for-each select="ProcessingHistory">
					...
					<xsl:choose>
						...
						<xsl:when test="@ProcessingType = 'Deconvolution_SVIHuygens' and contains(@ProcessingParameters, 'eDeconvolveImage' ) ">												
							<TR topmargin="0" leftmargin="0" border="0" bgcolor="#DDDAD7">
								<TD topmargin="0" leftmargin="0" align="left" style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 3px;">
									<B>
										<xsl:value-of select="@CreationTime"/>
								...
								<TD align="left" style="font-family: arial, helvetica; font-size: 7pt; font-weight: bold; color: 000000; padding: 3px;">
									<B>HyVolution Deconvolution</B>
								</TD>
							</TR>
							<TR border="1" bgcolor="#DDDAD7">
								<TD colspan="2" border="0" cellspacing="0" cellpadding="0">
									<TABLE style="display:block;" topmargin="0" leftmargin="0" width="100%" align="left" border="1" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
										<col width="38.2%" />
										<col width="61.8%" />
										<tr style="font-family: arial, helvetica; font-size: 7pt; font-weight: normal; color: 000000; padding: 3px;">
											<td>Programm</td>
											<td>
												<a style="font-weight: bold; color: 009b9b" title="Scientific Volume Imaging B.V." href="https://svi.nl/">
													SVI
												</a>&nbsp;
												<xsl:choose>
													<xsl:when test="contains(@ProcessingParameters, 'Essential')">
														<a style="color: 009b9b" title="Huygens Essential" href="https://svi.nl/HuygensEssential">Huygens Essential</a>
													</xsl:when>
													<xsl:when test="contains(@ProcessingParameters, 'Pro')">
														<a style="color: 009b9b" title="Huygens Pro" href="https://svi.nl/HuygensProfessional">Huygens Professional</a>
													</xsl:when>
													<xsl:otherwise>Unknown Programm Parameter</xsl:otherwise>
												</xsl:choose>
											</td>
										</tr>
										<tr style="font-family: arial, helvetica; font-size: 7pt; font-weight: normal; color: 000000; padding: 3px;">
											...
											<td>
												<xsl:choose>
													<xsl:when test="contains(@ProcessingParameters, 'HUPP_DECON_FAST')">Fast Computation</xsl:when>
													<xsl:when test="contains(@ProcessingParameters, 'HUPP_DECON_STANDARD')">Standard</xsl:when>
													<xsl:when test="contains(@ProcessingParameters, 'HUPP_DECON_BEST_RESOLUTION')">Best Resolution</xsl:when>
													<xsl:when test="contains(@ProcessingParameters, 'HUPP_DECON_HIGH_SPEED_IMAGING')">High Speed Imaging</xsl:when>
													<xsl:when test="contains(@ProcessingParameters, 'HUPP_DECON_LOW_SIGNAL_CONFOCAL')">Low Signal</xsl:when>
													<xsl:when test="contains(@ProcessingParameters, 'HUPP_DECON_NORMAL_SIGNAL_CONFOCAL')">Normal Signal</xsl:when>
													<xsl:when test="contains(@ProcessingParameters, 'HUPP_DECON_HIGH_SIGNAL_CONFOCAL')">High Signal</xsl:when>
													<xsl:otherwise>Unknown Strategy Parameter</xsl:otherwise>
												</xsl:choose>
											</td>
										</tr>
										<tr style="font-family: arial, helvetica; font-size: 7pt; font-weight: normal; color: 000000; padding: 3px;">
											...
											<td>
												<xsl:choose>
													<xsl:when test="contains(@ProcessingParameters, 'HUPP_CROP_CONSERVATIVE')">
														Allow auto-crop of image
														<xsl:if test="contains(@ProcessingParameters, 'CROP_OPTION_WAS_IGNORED')">
															<font style="color=red">&nbsp;(The crop option was ignored!)&nbsp;</font>
														</xsl:if>
													</xsl:when>
													<xsl:when test="contains(@ProcessingParameters, 'HUPP_CROP_NEVER')">No auto-crop</xsl:when>
													<xsl:otherwise>Unknown Crop Parameter</xsl:otherwise>
												</xsl:choose>
											</td>
										</tr>
										<xsl:if test="contains(@ProcessingParameters, 'eStitchImage')">
											<tr style="font-family: arial, helvetica; font-size: 7pt; font-weight: normal; color: 000000; padding: 3px;">
												<td>Merge image after deconvolution</td>
												<td>Active</td>
											</tr>
										</xsl:if>
									</TABLE>
						...
						<xsl:when test="@ProcessingType = 'Deconvolution_SVIHuygens' and contains(@ProcessingParameters, 'ePushImage' ) ">
							<TR topmargin="0" leftmargin="0" border="0" bgcolor="#DDDAD7">
								<TD topmargin="0" leftmargin="0" align="left" style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 3px;">
									<B>
										<xsl:value-of select="@CreationTime"/>
								...
								<TD align="left" style="font-family: arial, helvetica; font-size: 7pt; font-weight: bold; color: 000000; padding: 3px;">
									<B>Image received from <a style="color: 009b9b" title="Scientific Volume Imaging B.V." href="https://svi.nl/">SVI</a>&nbsp;Huygens</B>
								</TD>
							</TR>
							<TR border="1" bgcolor="#DDDAD7">
								<TD colspan="2" border="0" cellspacing="0" cellpadding="0">
		...
		<xsl:if test="@Application='Huygens' and node()!='' ">
			<TABLE width="98%" align="center" border="0" cellspacing="0" cellpadding="5">
				<TR>
					<TD align="left" style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 5px; spacing: 5px">
						<B> SVI Huygens <xsl:value-of select="@Name"/> </B>
					</TD>
				</TR>
				<TR border="1" bgcolor="#DDDAD7">
					<TD colspan="2" border="0" cellspacing="0" cellpadding="0">
